...
if __name__ == "__main__":
    ...
    (u, v) = list(G_gt_init.edges())[0]
    print(("random edge props:", G_gt_init.edges[u, v, 0]))

    # proposal graph
    with open(prop_file, 'rb') as fh:
        G_p_init = pickle.load(fh)
    #G_p_init0 = pickle.load(open(prop_file, 'rb'))
